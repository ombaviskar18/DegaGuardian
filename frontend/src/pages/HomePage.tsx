        ...
        <div className="workflow-container">
          ...
          >
            <h2 className="workflow-title">
              How DegaGuardian Works
            </h2>
            <p className="workflow-subtitle">
              Four-stage analysis powered by Dega Network and AI intelligence
            </p>
          </motion.div>
        ...
        <div className="footer-container">
          <div className="footer-content">
            ...
            <div className="footer-brand">
              <div className="footer-logo">
                <img src="/logos/logo.png" alt="DegaGuardian Logo" className="footer-logo-img" />
                <span className="footer-logo-text">DegaGuardian</span>
              </div>
            ...
            <div className="footer-links">
              ...
              <div className="footer-column">
                ...
                <ul className="footer-link-list">
                  <li><a href="#" className="footer-link">DegaGuardian AI</a></li>
          ...
          <div className="footer-bottom">
            <div className="footer-bottom-left">
              <p className="footer-copyright">© 2025 Copyright Dega Network · Built with ❤️ for DeFi security.</p>
